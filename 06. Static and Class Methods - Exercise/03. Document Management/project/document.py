...
class Document:
    def __init__(self, ident: int, category_id: int, topic_id: int, file_name: str):
        self.id = ident
    ...
    @classmethod
    def from_instances(cls, ident: int, category: Category, topic: Topic, file_name: str):
        category_id = category.id
        topic_id = topic.id
        return cls(ident, category_id, topic_id, file_name)
