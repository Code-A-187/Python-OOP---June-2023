...
class TestMovie(TestCase):
    ...
    def test_unique_actor_expect_success(self):
        self.assertEqual([], self.movie.actors)
    ...
    def test_movie_rating_first_movie_greater_then_second_movie(self):
    ...
    def test_movie_rating_second_movie_greater_then_first(self):
        new_movie = Movie("Elvis", 2022, 9.5)
